{{--iteration-2 department list page--}}
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between">
        <h2 class="text-lg leading-6 font-medium text-gray-900">Departments</h2>
        @can('alter-departments')
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        @can('alter-departments')
                                            ...
                                            <a wire:click.prevent="deleteDepartment({{$department->id}})"
